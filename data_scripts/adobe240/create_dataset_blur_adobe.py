...
def create_clips_overlap(video, root, destination, destionation_blur, listpath):
    ...
    for i in range(Num):
        ...
        #     img_list_2 = [11, 16, 13]
        # elif tau == 5:
        #     img_list_1 = [2,  3,  4,  5,  6]
        #     img_list_2 = [10, 11, 12, 13, 14]
        # elif tau == 7:
        #     img_list_1 = [1, 2, 3,    4, 5,  6,  7]
        #     img_list_2 = [9, 10, 11, 12, 13, 14, 15]
        # elif tau == 9:
        #     img_list_1 = [0, 1, 2, 3,  4,  5,  6,  7,  8]
        #     img_list_2 = [8, 9,10, 11, 12, 13, 14, 15, 16]
