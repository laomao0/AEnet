...
mod_scale = 4;
idx = 0;
imgDataPath = '/DATA/wangshen_data/vimeo_septuplet/sequences/';
...
save_LR_folder = strcat('/DATA/wangshen_data/','vimeo_septuplet_matlabLRx4');
if ~exist(save_LR_folder, 'dir')
    mkdir(save_LR_folder);
end

save_LR_folder = strcat('/DATA/wangshen_data/','vimeo_septuplet_matlabLRx4', '/', 'sequences');
if ~exist(save_LR_folder, 'dir')
    mkdir(save_LR_folder);
end
